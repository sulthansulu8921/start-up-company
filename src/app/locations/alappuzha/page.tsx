            ...
            <section className="pt-40 pb-24 px-6 relative overflow-hidden bg-black text-white text-center">
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/5 border border-white/10 text-white/60 text-[10px] font-black uppercase tracking-[0.3em] mb-8">
                        <MapPin size={14} className="text-neon" /> Tourism & Trade SEO
                    </motion.div>
                    <h1 className="text-6xl md:text-8xl font-black tracking-tighter mb-8 leading-[0.9]">Alappuzha <br /><span className="text-neon">Web Solutions</span></h1>
                    <p className="max-w-2xl text-white/60 text-lg md:text-xl font-bold leading-relaxed mb-10 mx-auto">Transforming Alappuzha&apos;s tourism, coir, and retail business into global brands with premium digital experiences.</p>
