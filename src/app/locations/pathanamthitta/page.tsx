...
import { MapPin, Globe, ArrowRight, Zap, Target, Star, Shield, BarChart, RefreshCw } from "lucide-react";
            ...
            <section className="py-24 px-6 bg-white">
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        {[
                            { icon: RefreshCw, title: "NRI Portal Tech", desc: "Specialized platforms for Pathanamthitta&apos;s global NRI community." },
                            { icon: Target, title: "Spiritual SEO", desc: "Ranking local pilgrimage and heritage business for global search." },
                            { icon: Shield, title: "Enterprise Maintenance", desc: "Proactive surveillance for major regional corporate assets." }
                        ].map((item, i) => (
