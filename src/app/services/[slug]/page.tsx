...
import { ArrowRight, Zap, CheckCircle2, ArrowLeft } from "lucide-react";
...
export default function ServiceDetailPage({ params }: PageProps) {
    ...
    // Background parallax & opacity management (synchronized with landing page feel)
    ...
    return (
        <main className="relative min-h-screen bg-black pt-32 pb-20 overflow-hidden">
            {/* ── Persistent Content Background (Ken Burns Animation - inherited from layout) ─────────────────────── */}
            ...
            {/* ── Project Roadmap (Day-by-Day Process) ─────────────────────── */}
