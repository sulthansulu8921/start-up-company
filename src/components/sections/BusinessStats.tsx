            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-20">
                    <ScrollReveal variant="fade-right" className="max-w-2xl">
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-lg bg-white/5 border border-white/10 text-white/60 text-[10px] font-black uppercase tracking-[0.3em] mb-6">
                            <Cpu size={12} className="text-neon" />
                            Data Integration / v2.0
                        </div>
                        <h2 className="text-4xl md:text-6xl font-black font-sora text-white leading-tight tracking-tighter">
                            The <span className="text-neon">Metric</span> of <br className="hidden md:block" /> Excellence
                        </h2>
                    </ScrollReveal>
                    
                    <ScrollReveal variant="fade-left" delay={0.2} className="flex items-center gap-4 text-white/40 text-sm font-bold border-l border-white/10 pl-6 md:pl-8 z-20 relative bg-black/20 backdrop-blur-sm rounded-r-lg">
                ...
                {/* Footer Glow Label */}
                <ScrollReveal variant="fade-up" delay={0.4} className="mt-16 pt-8 border-t border-white/5 flex flex-wrap gap-8 justify-center items-center opacity-40 hover:opacity-100 transition-opacity grayscale hover:grayscale-0">
